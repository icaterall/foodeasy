...
//            ->where('custom_fields.in_table', '=', true)
    ...
    {
        return \App\Models\DeliveryAddress::where('user_id',$this->id)->where('is_default',1)->select(['suite_floor','address'])->first()->toArray();
    }
     ...
     * @return bool
     */
    public function getSuiteFloorAttribute()
    {
        return \App\Models\DeliveryAddress::where('user_id',$this->id)->where('is_default',1)->pluck('suite_floor')->first();
    }
    ...
    {
        return \App\Models\DeliveryAddress::where('user_id',$this->id)->where('is_default',1)->pluck('address')->first();
    }
